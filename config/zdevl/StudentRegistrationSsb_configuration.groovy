		...
		springsecurity {
			...
			saml {
				...
				keyManager {
					...
					passwords = [ 'zdevl-registrationss-sp': keystore_pass ]
					defaultKey = 'zdevl-registrationss-sp'
				}
				metadata {
					...
					sp {
						...
						defaults = [
							local: true,
							alias: 'zdevl-registrationss-sp',
							securityProfile: 'metaiop',
							signingKey: 'zdevl-registrationss-sp',
							encryptionKey: 'zdevl-registrationss-sp',
							tlsKey: 'zdevl-registrationss-sp',
