		...
		springsecurity {
			...
			saml {
				...
				keyManager {
					...
					passwords = [ 'zdevl-employeess-sp': keystore_pass ]
					defaultKey = 'zdevl-employeess-sp'
				}
				metadata {
					...
					sp {
						...
						defaults = [
							local: true,
							alias: 'zdevl-employeess-sp',
							securityProfile: 'metaiop',
							signingKey: 'zdevl-employeess-sp',
							encryptionKey: 'zdevl-employeess-sp',
							tlsKey: 'zdevl-employeess-sp',
