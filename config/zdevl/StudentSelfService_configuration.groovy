		...
		springsecurity {
			...
			saml {
				...
				keyManager {
					...
					passwords = [ 'zdevl-studentss-sp': keystore_pass ]
					defaultKey = 'zdevl-studentss-sp'
				}
				metadata {
					...
					sp {
						...
						defaults = [
							local: true,
							alias: 'zdevl-studentss-sp',
							securityProfile: 'metaiop',
							signingKey: 'zdevl-studentss-sp',
							encryptionKey: 'zdevl-studentss-sp',
							tlsKey: 'zdevl-studentss-sp',
