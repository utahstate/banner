...
String bdm_host = (System.getenv("BDM_HOST") ?: "https://xtenderdev.banner.usu.edu")

bdm.enabled = true  // boolean value
bdmserver.file.location = "/opt/banner/xtender"
bdmserver.AXWebServicesUrl = bdm_host + "/AppEnhancerServices/axservicesinterface.asmx"
bdmserver.AXWebAccessURL = bdm_host + '/AppEnhancer/'
bdmserver.Username = (System.getenv('BDMSERVER_USERNAME') ?: 'BDMAPI_SUPERUSER')
bdmserver.DataSource = (System.getenv('BDMSERVER_DATASOURCE') ?: 'ZDEVL')
bdmserver.BdmDataSource = (System.getenv('BDMSERVER_BDMDATASOURCE') ?: 'ZDEVL')
