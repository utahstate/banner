...
/**
 *    This is the default logging configuration for the FinanceSelfService application.
 *
 *    Each Banner application will have its own logging file.  Example: FinanceSelfService.log
 *    Banner logging files are set up to roll on a daily basis with SizeAndTimeBasedRolling Policy. Example: FinanceSelfService-2019-03-05-0.log
 *
