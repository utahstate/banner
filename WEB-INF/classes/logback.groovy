 ...
 *
 *    Each Banner application will have its own logging file.  Example: EmployeeSelfService.log
 *    Banner logging files are set up to roll on a daily basis with SizeAndTimeBasedRolling Policy. Example: EmployeeSelfService-2019-03-05-0.log
 *
