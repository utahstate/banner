...
/**
 *    This is the default logging configuration for the StudentAPI application.
 *
 *    Each Banner application will have its own logging file.  Example: StudentAPI.log
 *    Banner logging files are set up to roll on a daily basis with SizeAndTimeBasedRolling Policy. Example: StudentAPI-2019-03-05-0.log
 *
