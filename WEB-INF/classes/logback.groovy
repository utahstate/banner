...
//******* Communication Management packages *******
//logger("org.quartz",ERROR)
//logger("quartz",ERROR)
//logger("org.quartz.impl.jdbcjobstore", ERROR)
//logger( 'net.hedtech.banner.general.communication', DEBUG)
//logger( 'net.hedtech.banner.general.scheduler', DEBUG)
//logger( 'net.hedtech.banner.general.asynchronous', DEBUG)
