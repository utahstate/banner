...
//  Location of the employee photos
banner.picturesPath=picturesPath = (System.getenv('BANNER_PICTURESPATH') ?: '/test/images')
...
If going through SSO manager then it would look as below:
mep.banner8.SS.url = [
