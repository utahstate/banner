...
bdmserver.defaultFileSize = 128  ////default file size in MB to be restricted
...
banner {
    sso {
        authenticationProvider = 'default' //  Valid values are: 'default', 'cas' and 'saml'
...
targetServer = "tomcat" // For weblogic deployment
