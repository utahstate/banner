...
ENV CATALINA_OPTS="-server -Xms\$XMS -Xmx\$XMX -XX:MaxPermSize=1024m -Dlog4j.configuration=config.properties -Duser.timezone=\$TIMEZONE -Doracle.jdbc.autoCommitSpecCompliant=false"
