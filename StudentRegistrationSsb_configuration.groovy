 ...
 *                                                                              *
 ***************************************************************************** **/
banner8.SS.studentAccountUrl = "https://ssb.banner.usu.edu/zprod/twbkwbis.P_GenMenu?name=bmenu.P_ARMnu"
...
grails {
    plugin {
        springsecurity {
            cas {
                active = true
                serverUrlPrefix  = 'https://login.usu.edu/cas'
                serviceUrl       = "https://ss.banner.usu.edu/StudentRegistrationSsb/j_spring_cas_security_check"
                serverName       = "https://ss.banner.usu.edu"
                proxyCallbackUrl = "https://ss.banner.usu.edu/StudentRegistrationSsb/secure/receptor"
                loginUri         = '/login'
                sendRenew        = false
            ...
            logout {
                afterLogoutUrl = "http://banner.usu.edu"
            }
        }
    }
}
...
grails {
    mail {
        host = 'mailhost.sct.com'
    }
}
grails.mail.default.from='firstname.lastname@ellucian.com'
allowPrint = true
...
//
GENERALLOCATION= 'https://ss.banner.usu.edu/BannerGeneralSsb'
 ...
 *                                                                              *
 ***************************************************************************** **/
grails.plugin.springsecurity.homePageUrl= 'https://ss.banner.usu.edu/StudentRegistrationSsb' 
